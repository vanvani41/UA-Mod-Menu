...
<details>
  <summary><b>Why menu is open-source?</b></summary>
	I want to help other guys to create a mod menu too! I want to share the code of UA Mod Menu, so they can learn how to create their **own** mod menu.
</details>

<details>
  <summary><b>Can I use your mod menu's code?</b></summary>
	
**Yes, you can!** But there’s a problem for you, monke! I have [**GPL-3.0 License**](https://www.gnu.org/licenses/gpl-3.0.html) license, which means that if you use my code:  
- Your project **must** also be open-sourced.  
...
UA Mod Menu - це **найперший український** мод меню для Gorilla Tag, зроблений мною, [**vanvani41**](https://github.com/vanvani41). На данний момент у меню немає української мови, але в майбутньому я додам її. Також, я використовував [iis Stupid Template](https://github.com/iiDk-the-actual/iis.Stupid.Template) та ЧатGPT для фіксів щоб зробити UA Мод Меню.

<details>
  <summary><b>Чому джерело меню відкрите?</b></summary>
	Я хочу допомогти іншим теж зробити мод меню! Я хочу поділитися кодом UA Mod Menu для усіх, щоб вони могли навчитися створювати **своє власне** мод меню.
</details>

<details>
  <summary><b>А можна використовувати код меню?</b></summary>
	
**Так, можна!** Але монке, ти матимеш проблему! Я маю ліцензію **[**GPL-3.0*Я*](https://www.gnu.org/licenses/gpl-3.0.html)**, тому якщо ти використовуватимеш мій код:  
